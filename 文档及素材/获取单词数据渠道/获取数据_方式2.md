...
收词量 340万，输出《[简明英汉字典增强版](https://github.com/skywind3000/ECDICT/wiki/简明英汉字典增强版)》文件说明：
...
GoldenDict 用户不要使用老旧的 1.0，请使用 1.5以后版本才支持 mdx 词典格式：

- [GoldenDict for Windows](https://github.com/goldendict/goldendict/wiki/Early-Access-Builds-for-Windows)
...
特地发布一个 Kindle 版本的 mobi 格式字典，因为 mobigen.exe 太费内存，又不提供 64位的，因此只能生成这么一个 100万词条数量的 mobi 词典，不过已经是 Kindle 上最大的词典了。
